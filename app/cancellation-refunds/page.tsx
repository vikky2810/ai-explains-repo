        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section className="bg-slate-900/60 backdrop-blur-sm border border-slate-800/80 rounded-md p-8 shadow-2xl">
            ...
            <p className="text-slate-300 leading-relaxed">
              This page explains our approach to cancellations and refunds for applicable purchases.
            </p>
          </section>
          ...
          <section className="bg-slate-900/60 backdrop-blur-sm border border-slate-800/80 rounded-md p-8 shadow-2xl">
            ...
            <ul className="text-slate-300 space-y-2 list-disc list-inside">
              <li>Provide proof of purchase or account email.</li>
              <li>Describe the issue and desired resolution.</li>
              <li>We respond as soon as possible after review.</li>
            </ul>
          </section>
