        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section className="bg-slate-900/60 backdrop-blur-sm border border-slate-800/80 rounded-md p-8 shadow-2xl">
            ...
            <p className="text-slate-300 leading-relaxed">
              We aim to handle information responsibly and minimize collection where possible.
            </p>
          </section>
          ...
          <section className="bg-slate-900/60 backdrop-blur-sm border border-slate-800/80 rounded-md p-8 shadow-2xl">
            ...
            <ul className="text-slate-300 space-y-2 list-disc list-inside">
              <li>Review and update your account details when available.</li>
              <li>Contact support for questions about your information.</li>
            </ul>
          </section>
