        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <section className="bg-slate-900/60 backdrop-blur-sm border border-slate-800/80 rounded-2xl p-8 shadow-2xl">
            <form className="space-y-6">
              ...
              <button type="submit" className="inline-flex items-center gap-2 px-6 py-3 bg-accent hover:bg-accent-dim rounded-xl font-semibold text-slate-950 shadow-lg transition-all duration-200">
                <span>Send</span>
              </button>
            </form>
          </section>
